...
public class AdminForgetPass implements Initializable
{
    ...
    private void done(ActionEvent e) throws IOException
    {
        ...
        info[2] = newPass.getText();
        list.set(a, info[0]+" "+info[1]+" "+info[2]+" "+info[3]+" "+info[4]+" "+info[5]);
    ...
    private void submit()
    {
        ...
        for(int i=0; i<list.size(); i++)
        {
            ...
            if(mt.getText().equals(info[3]) && ut.getText().equals(info[5]))
            {
                flag = true;
                a = i;
