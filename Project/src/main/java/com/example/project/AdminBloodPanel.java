...
public class AdminBloodPanel implements Initializable
{
    ...
    @FXML
    private Label r1, r2, r3, r4, r5, r6, r7, r8;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        String path = "D:\\Team Falcon (AOOP Project)\\Project\\src\\main\\resources\\com\\example\\All File\\Blood Bank\\"+ob.getHospitalName()+".txt";
    ...
    private void bb1()
    {
        list.set(0, labelList.get(0).getText()+" "+t1.getText());
    ...
    private void bb2()
    {
        list.set(1, labelList.get(1).getText()+" "+t2.getText());
    ...
    private void bb3()
    {
        list.set(2, labelList.get(2).getText()+" "+t3.getText());
    ...
    private void bb4()
    {
        list.set(3, labelList.get(3).getText()+" "+t4.getText());
    ...
    private void bb5()
    {
        list.set(4, labelList.get(4).getText()+" "+t5.getText());
    ...
    private void bb6()
    {
        list.set(5, labelList.get(5).getText()+" "+t6.getText());
        r6.setText(t6.getText());
        t6.clear();
        this.fileWrite();
    }
    ...
    private void bb7()
    {
        list.set(6, labelList.get(6).getText()+" "+t7.getText());
        r7.setText(t7.getText());
        t7.clear();
        this.fileWrite();
    }
    ...
    private void bb8()
    {
        list.set(7, labelList.get(7).getText()+" "+t8.getText());
        r8.setText(t8.getText());
        t8.clear();
        this.fileWrite();
    }
